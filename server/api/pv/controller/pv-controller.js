...
module.exports = class PvController {
  static getAll(req, res) {
    ...
    Operator
      .getAll(moduleConst.pv, moduleConst.pv, paras)
    ...
    Operator
      ...
      .then((data) => {
        ...
        exportPV.getSheets((ret) => {
          ...
          res.end(new Buffer(ret, 'base64'));
        });
      })
      .catch(err => res.status(400).json(err));
  }

  static exportSheets(req, res) {
    Operator
  ...
  static yearlySum(req, res) {
    Operator
      .yearlySum(moduleConst.pv, moduleConst.pv)
      .then(data => res.status(200).json(data))
      .catch(err => res.status(400).json(err));
  }
}
